...
Model.new(:jenkins_lifesense_com, 'Description for jenkins_lifesense_com') do

  archive :my_archive do |archive|
    archive.add "/data/jenkins_home"
    archive.add "/data/apps/node-v6.1.0-linux-x64"
    archive.exclude "/data/jenkins_home/workspace"
    archive.exclude  "/data/jenkins_home/jobs/maven_build/builds"
  end
